...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      <aside 
        style={ phoneActive
          ? {width:"20rem",height:"100vh",position:'fixed',top: 0,left:showModal?"0":"-20rem", transition:"all 0.5s"}
        :{}}
      >
        <h2>Logo</h2>
  ...
  <div>
    <h5>Dashboard</h5>
      <ul>
        ...
        <Li url="/admin/transactions" text="Transactions" location={location} Icon={AiFillFileText} />
      </ul>
  </div>
);
